class DetailSurahModel {
  ...
  final DetailSurahModelTafsir? tafsir;
  ...
  factory DetailSurahModel.fromJson(Map<String, dynamic> json) => DetailSurahModel(
        ...
        tafsir: json["tafsir"] == null ? null : DetailSurahModelTafsir.fromJson(json["tafsir"]),
...
class DetailSurahModelTafsir {
  ...
  factory DetailSurahModelTafsir.fromJson(Map<String, dynamic> json) => DetailSurahModelTafsir(
        id: json["id"],
      );
